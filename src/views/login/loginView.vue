  ...
  <div class="main">
    ...
    <div class="login_header">
      ...
      <div class="options_container">
        <i @click="btnHref('https://github.com/DiCaprioGD/vue3_demo')"
          ><svg
            t="1734247938277"
            class="icon"
    ...
    <div class="login_container">
      ...
      <div class="register_container">
        <template v-if="!isRegister">
          <span style="color: var(--font-color-gray-3)">没有账号吗? </span
          ><span style="cursor: pointer" @click="isRegister = !isRegister">注册新账号</span>
        </template>
        <template v-else>
          <span style="color: var(--font-color-gray-3)">已有账号? </span
          ><span style="cursor: pointer" @click="isRegister = !isRegister">登录</span>
        </template>
      </div>
...
watch(
  () => isRegister.value,
  () => {
    loginItem.value.map((item) =>
      Object.keys(item).indexOf('isHidden') >= 0 ? (item.isHidden = !item.isHidden) : ''
    )
  }
)
const btnConfirm = () => {
